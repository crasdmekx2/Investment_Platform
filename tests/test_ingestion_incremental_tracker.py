...
class TestIncrementalTracker:
    ...
    def test_calculate_missing_ranges_no_existing(self, db_cursor):
        ...
        missing = tracker.calculate_missing_ranges(
    ...
    def test_calculate_missing_ranges_with_gaps(self, db_cursor):
        ...
        db_cursor.execute("DELETE FROM market_data WHERE asset_id IN (SELECT asset_id FROM assets WHERE symbol = 'MISSING_GAPS')")
