...
def classify_error(error: Exception, error_message: Optional[str] = None) -> Tuple[str, str]:
    ...
    transient_indicators = [
        ...
        'connection', 'network', 'econnrefused', 'econnreset',
        'temporary', 'retry', '503', 'service unavailable',
    ...
    permanent_indicators = [
        ...
        'symbol', 'asset', 'format', 'malformed',
        'unsupported', 'not supported',
    ]
    
    # System errors (infrastructure issues)
    system_indicators = [
        'database', 'postgres', 'sql', 'connection pool',
        'memory', 'disk', 'ioerror', 'oserror',
